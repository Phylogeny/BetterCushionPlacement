...
Vanilla cushion support is as follows [Cushion_wouldSuriveAt](https://mcsrc.dev/1/26.3-snapshot-6/net/minecraft/world/entity/decoration/Cushion#L155-163):
- [L156-158](https://mcsrc.dev/1/26.3-snapshot-6/net/minecraft/world/entity/decoration/Cushion#L156-158) Make an anchor box by taking the bounding box a cushion is or might be, and slightly horizontally shrinking it and vertically expanding it down by 1/4 pixel.
- [159](https://mcsrc.dev/1/26.3-snapshot-6/net/minecraft/world/entity/decoration/Cushion#159) Iterate the blocks intersecting that area additionally expanded down by another 4 pixels.
    - [160](https://mcsrc.dev/1/26.3-snapshot-6/net/minecraft/world/entity/decoration/Cushion#160) For each block, get its general shape.
    - [161](https://mcsrc.dev/1/26.3-snapshot-6/net/minecraft/world/entity/decoration/Cushion#161) Consider it supported if that shape is not empty and if it intersects the anchor box.
...
Vanilla block interaction behavior is as follows [BlockGetter_clipWithInteractionOverride](https://mcsrc.dev/1/26.3-snapshot-6/net/minecraft/world/level/BlockGetter#L84-96):
- [L87](https://mcsrc.dev/1/26.3-snapshot-6/net/minecraft/world/level/BlockGetter#L87) Raytrace a block's main shape.
- [L88](https://mcsrc.dev/1/26.3-snapshot-6/net/minecraft/world/level/BlockGetter#L88) Check for hit.
   - [L89](https://mcsrc.dev/1/26.3-snapshot-6/net/minecraft/world/level/BlockGetter#L89) If hit, raytrace the block's interaction shape.
   - [L90](https://mcsrc.dev/1/26.3-snapshot-6/net/minecraft/world/level/BlockGetter#L90) Check for hit, and check if it's closer to the eyes than the main shape hit.
      - [L91](https://mcsrc.dev/1/26.3-snapshot-6/net/minecraft/world/level/BlockGetter#L91) If the interaction shape hit is closer than main shape hit, substitute the direction of the hit result with the new direction.

Blocks by default have no interaction shape [BlockBehaviour_getInteractionShape](https://mcsrc.dev/1/26.3-snapshot-6/net/minecraft/world/level/block/state/BlockBehaviour#L296-298), with the following exceptions:
- Cauldrons [getInteractionShape](https://mcsrc.dev/1/26.3-snapshot-6/net/minecraft/world/level/block/AbstractCauldronBlock#L71-74)
- Composters [getInteractionShape](https://mcsrc.dev/1/26.3-snapshot-6/net/minecraft/world/level/block/ComposterBlock#L100-103)
- Hoppers [getInteractionShape](https://mcsrc.dev/1/26.3-snapshot-6/net/minecraft/world/level/block/HopperBlock#L72-75)
- Scaffolding [getInteractionShape](https://mcsrc.dev/1/26.3-snapshot-6/net/minecraft/world/level/block/ScaffoldingBlock#L67-70)
...
Note that raytrace is from the eyes [L84](https://mcsrc.dev/1/26.3-snapshot-6/net/minecraft/world/item/CushionItem#L84) to the slightly past the exiting hit result vector [L85-86](https://mcsrc.dev/1/26.3-snapshot-6/net/minecraft/world/item/CushionItem#L85-86), and that hit failure defaults to the original hit result [L88](https://mcsrc.dev/1/26.3-snapshot-6/net/minecraft/world/item/CushionItem#L88). This means that when a collision shape hit is closer to the eyes than the main shape hit, as with wall blocks [WallBlock_collisionShapes](https://mcsrc.dev/1/26.3-snapshot-6/net/minecraft/world/level/block/WallBlock#L58), the collision shape will be used. But when the main shape hit is closer, as with soul sand blocks [SoulSandBlock_SHAPE](https://mcsrc.dev/1/26.3-snapshot-6/net/minecraft/world/level/block/SoulSandBlock#L13), the main shape will be used in spite of having the tag.
